export const exoticPositionalMarketContract = {
    abi: [
            ...
            outputs: [
                {
                    components: [
                        ...
                        { internalType: 'enum ExoticPositionalMarket.TicketType', name: 'ticketType', type: 'uint8' },
        ...
        {
            inputs: [{ internalType: 'uint256', name: '_position', type: 'uint256' }],
            name: 'getPotentialWinningAmountForPosition',
            outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
            stateMutability: 'view',
            type: 'function',
        },
        ...
        },
        {
            inputs: [],
            name: 'ticketType',
            outputs: [{ internalType: 'enum ExoticPositionalMarket.TicketType', name: '', type: 'uint8' }],
            stateMutability: 'view',
            type: 'function',
        },
        {
        ...
        },
        {
            ...
            name: 'transferFromBondAmountToRecepient',
            outputs: [],
            stateMutability: 'nonpayable',
            type: 'function',
        },
