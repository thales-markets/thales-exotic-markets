    ...
    abi: [
        {
            ...
            inputs: [
                ...
                { indexed: false, internalType: 'uint256', name: 'decidedOption', type: 'uint256' },
            ],
            name: 'DisputeClosed',
            type: 'event',
        },
        {
            ...
            inputs: [
                { indexed: false, internalType: 'address', name: 'market', type: 'address' },
                { indexed: false, internalType: 'uint256', name: 'disputeFinalCode', type: 'uint256' },
            ],
        ...
        },
        {
            ...
            inputs: [
                { indexed: false, internalType: 'address', name: 'market', type: 'address' },
                { indexed: false, internalType: 'string', name: 'disputeString', type: 'string' },
                { indexed: false, internalType: 'address', name: 'disputorAccount', type: 'address' },
            ],
            name: 'NewDispute',
            type: 'event',
        },
        {
            anonymous: false,
            inputs: [{ indexed: false, internalType: 'address', name: 'marketManager', type: 'address' }],
        ...
        },
        {
            anonymous: false,
            inputs: [
                { indexed: false, internalType: 'address', name: 'councilMember', type: 'address' },
                { indexed: false, internalType: 'uint256', name: 'councilMemberCount', type: 'uint256' },
            ],
        ...
        {
            inputs: [{ internalType: 'address', name: '_councilMember', type: 'address' }],
        ...
        },
        {
            ...
            name: 'dispute',
            outputs: [
                { internalType: 'address', name: 'disputorAddress', type: 'address' },
                { internalType: 'string', name: 'disputeString', type: 'string' },
                { internalType: 'uint256', name: 'disputeCode', type: 'uint256' },
                { internalType: 'uint256', name: 'disputeTimestamp', type: 'uint256' },
                { internalType: 'bool', name: 'disputeInPositioningPhase', type: 'bool' },
            ],
            stateMutability: 'view',
            type: 'function',
        },
        ...
        },
        {
            ...
            name: 'getDistputeAddressOfDisputor',
            outputs: [{ internalType: 'address', name: '', type: 'address' }],
            stateMutability: 'view',
            type: 'function',
        },
        ...
        { inputs: [], name: 'initNonReentrant', outputs: [], stateMutability: 'nonpayable', type: 'function' },
        {
            inputs: [
                ...
                { internalType: 'address', name: '_marketManager', type: 'address' },
            ],
            name: 'initialize',
            outputs: [],
            stateMutability: 'nonpayable',
        ...
        },
        {
            inputs: [
                { internalType: 'address', name: '_market', type: 'address' },
                { internalType: 'string', name: '_disputeString', type: 'string' },
            ],
            name: 'openDispute',
            outputs: [],
            stateMutability: 'nonpayable',
        ...
        {
            inputs: [{ internalType: 'address', name: '_marketManager', type: 'address' }],
        ...
        },
        {
            inputs: [
                { internalType: 'address', name: '_market', type: 'address' },
                { internalType: 'uint256', name: '_disputeIndex', type: 'uint256' },
                { internalType: 'uint256', name: '_disputeCodeVote', type: 'uint256' },
                { internalType: 'uint256', name: '_winningPosition', type: 'uint256' },
            ],
            name: 'voteForDispute',
            outputs: [],
            stateMutability: 'nonpayable',
